...
Route::get('total-employeeprojects/{id}', [\App\Http\Controllers\EmployeeProjectController::class, 'showProjectById']);
...
Route::get('total-employee/{id}', [\App\Http\Controllers\EmployeeTasksController::class, 'showEmployeebyId']);
Route::get('total-employee/{id}', [\App\Http\Controllers\EmployeeProjectController::class, 'showTaskById']);
